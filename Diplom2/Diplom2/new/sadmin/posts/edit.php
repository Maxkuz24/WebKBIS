    ...
    <div class="container">
        ...
        <div class="posts col-9">
            ...
            <div class="row add-post">
                ...
                $id = $_GET['id'];
                $product = mysqli_query($connect, "SELECT * FROM `zapisi` WHERE `id` = '$id'");
                ...
                <body align="center">
                    ...
                    <form action="update2.php" method="post">
                        ...
                        <p>Преподаватель</p>
                        <input type="text" name="prepodawatel" value="<?= $product['prepodawatel'] ?>">
                        <p style="color: #000;">Максимальное колличество студентов на приём</p>
                        <input type="text" name="kolprepod" value="<?= $product['kolprepod'] ?>">
                        <p>Кабинет</p>
                        <input type="text" name="kabinet" value="<?= $product['kabinet'] ?>">

    ...
    <div class="container">
        ...
        <div class="panel col-9">
            <div class="button row">
                ...
                <a href="<?php echo BASE_URL . "sadmin/zapisi/index.php"; ?>"
                    class="col-2 btn btn-warning">Вернуться</a>
            </div>
            <div class="row title-table">
                <h2>Добавление перподавателя</h2>
            </div>
            <div class="row add-post">
                ...
                <form action="create1.php" method="post" align="center">
                    ...
                    <br> <br>
                    <button name="edit_post" class="btn btn-primary" type="submit">Добавить преподавателя</button>
                </form>

                <!-- <form action="create1.php" method="post" enctype="multipart/form-data">
                    <div class="col mb-4">
                        <input value="<?= $title; ?>" name="title" type="text" class="form-control"
                            placeholder="Введите ФИО" aria-label="ФИО перподавателя">
                    </div>
                    <div class="col">
                        <label for="content" class="form-label">Описание проподавателя</label>
                    ...
                    <div class="col col-6">
                        <button name="add_post" class="btn btn-primary" type="submit">Добавить преподавателя</button>
                    </div>
                </form> -->
            </div>
        </div>

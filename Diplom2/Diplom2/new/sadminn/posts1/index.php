        ...
        <div class="panel col-9">
            ...
            <?php foreach ($postsAdm as $key => $post): ?>
                <div class="row post">
                    ...
                    <div class="del col-2"><a href="edit.php?delete_id=<?= $post['id']; ?>">Удал.</a></div>
                    <?php if ($post['status']): ?>

                        <div class="status col-1"><a href="edit.php?publish=0&pub_id=<?= $post['id']; ?>">Опубликовано</a></div>
                    <?php else: ?>
                        <div class="status col-1"><a href="edit.php?publish=1&pub_id=<?= $post['id']; ?>">Скрыто</a></div>
                    <?php endif; ?>
                </div>
            <?php endforeach; ?>
        </div>
